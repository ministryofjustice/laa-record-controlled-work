...
.PHONY: install prek-install dev watch docker-up docker-down build lint lint-fix integration integration-watch e2e e2e-ui test-all coverage unit unit-watch

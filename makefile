...
.PHONY: dev watch docker-up docker-down build lint lint-fix lint-fix-generated integration integration-watch e2e e2e-ui test-all coverage unit unit-watch
